    ...
    <>
      ...
      <motion.div
        ...
        animate={{ 
          ...
          opacity: 0.7,
          rotate: 360,
          x: calcMouseX * 35 - 17.5 + mouseDelta.x * 1.5,
          y: calcMouseY * 35 - 17.5 + mouseDelta.y * 1.5,
      ...
      <motion.div
        ...
        animate={{ 
          ...
          opacity: 0.8,
          rotate: -360,
          x: calcMouseX * -40 + 20 + mouseDelta.x * -2,
          y: calcMouseY * -40 + 20 + mouseDelta.y * -2,
      ...
      <motion.div
        ...
        animate={{ 
          ...
          rotate: 360,
          scale: [1, 1.1, 1],
          x: calcMouseX * -70 + mouseDelta.x * 4, // More responsive to mouse movement
          filter: `blur(${mouseSpeed * 0.06}px)` // Dynamic blur based on mouse speed
        }}
        transition={{ 
      ...
      <motion.div
        ...
        animate={{ 
          ...
          rotate: -360,
          scale: [1, 1.15, 1],
          x: calcMouseX * 70 + mouseDelta.x * -4.5, // More responsive to mouse movement
      ...
      <motion.div
        ...
        animate={{ 
          ...
          rotate: 180,
          scale: [1, 1.1, 1],
          x: calcMouseX * 55 + mouseDelta.x * 5, // More responsive to mouse movement
